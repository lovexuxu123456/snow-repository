...
import com.snow.umtask.listener.JobChainedJobListener;
...
public class SchedulerManager {
    ...
    public JobListener makeEmailJobListener(EmailListenerPm emailListenerPm) {
        JobExceptionListener jobEmailListener = new JobExceptionListener(emailListenerPm.getListenerName());
        return jobEmailListener;
    }
}
